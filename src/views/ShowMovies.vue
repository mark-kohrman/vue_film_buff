<template>
  ...
  <div class="container">
    <svg v-on:click="thumbsUp()" xmlns="http://www.w3.org/2000/svg" width="48" height="48" fill="white" class="bi bi-hand-thumbs-up" viewBox="0 0 16 16">
    ...
    <h2 style="color:white"> {{ movie.thumbs_up}} </h2>
  </div>

<br>

  <div class="container">
    <svg v-on:click="thumbsDown()" xmlns="http://www.w3.org/2000/svg" width="48" height="48" fill="white" class="bi bi-hand-thumbs-down" viewBox="0 0 16 16">
    ...
    <h2 style="color:white"> {{ movie.thumbs_down}} </h2>
  </div>
